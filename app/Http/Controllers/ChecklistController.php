...
//         return redirect()->route('entradas.show', $validated['No_orden_entrada'])->with('success', 'Checklist guardado correctamente.');
//     }
...
//         return redirect()->route('checklists.show', $checklist->id_checklist)->with('success', 'Checklist actualizado correctamente.');
//     }
// }
