    ...
    <form method="POST" action="{{ route('salidas.store') }}">
        ...
        <div class="card card-secondary">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <x-adminlte-input name="VIN" label="VIN" maxlength="17" value="{{ $vehiculo->VIN ?? '' }}" />
                    </div>
                    <div class="col-md-4">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <x-adminlte-select name="Almacen_salida" label="Almacén Salida" required>
                    ...
                    <div class="col-md-4">
                        <x-adminlte-input name="Fecha_salida" label="Fecha Salida" type="date" value="{{ date('Y-m-d') }}" />
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card card-info">
            ...
            <div class="card-body" id="checklist-container">
                @if($ultimoChecklist)
                    <!-- Usamos datos del último checklist -->
                    @php $c = $ultimoChecklist; @endphp
                    <input type="hidden" name="documentos_completos" value="0">
                    <div class="form-check mb-2">
                        <input class="form-check-input checklist-item" type="checkbox" name="documentos_completos" value="1" {{ $c->documentos_completos ? 'checked' : '' }}>
                        <label class="form-check-label">Documentos Completos</label>
                    </div>

                    <input type="hidden" name="accesorios_completos" value="0">
                    <div class="form-check mb-2">
                        <input class="form-check-input checklist-item" type="checkbox" name="accesorios_completos" value="1" {{ $c->accesorios_completos ? 'checked' : '' }}>
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input checklist-item" type="checkbox" name="pdi_realizada" value="1" {{ $c->pdi_realizada ? 'checked' : '' }}>
                        <label class="form-check-label">PDI Realizada</label>
                    </div>

                    <input type="hidden" name="seguro_vigente" value="0">
                    <div class="form-check mb-2">
                        <input class="form-check-input checklist-item" type="checkbox" name="seguro_vigente" value="1" {{ $c->seguro_vigente ? 'checked' : '' }}>
                        <label class="form-check-label">Seguro Vigente</label>
                    </div>

                    <input type="hidden" name="nfc_instalado" value="0">
                    <div class="form-check mb-2">
                        <input class="form-check-input checklist-item" type="checkbox" name="nfc_instalado" value="1" {{ $c->nfc_instalado ? 'checked' : '' }}>
                        <label class="form-check-label">NFC Instalado</label>
                    </div>

                    <input type="hidden" name="gps_instalado" value="0">
                    <div class="form-check mb-2">
                        <input class="form-check-input checklist-item" type="checkbox" name="gps_instalado" value="1" {{ $c->gps_instalado ? 'checked' : '' }}>
                        <label class="form-check-label">GPS Instalado</label>
                    </div>

                    <input type="hidden" name="folder_viajero" value="0">
                    <div class="form-check mb-2">
                        <input class="form-check-input checklist-item" type="checkbox" name="folder_viajero" value="1" {{ $c->folder_viajero ? 'checked' : '' }}>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // 1. Actualizar observaciones automáticamente según checklist
    // 2. Cambiar estado del vehículo (fuera / disponible)
});
</script>
@endsection --}}
...
@endisset
                    ...
                    <div class="col-md-4">
                        <x-adminlte-input name="Fecha" label="Fecha Salida" type="date" value="{{ date('Y-m-d') }}" />
